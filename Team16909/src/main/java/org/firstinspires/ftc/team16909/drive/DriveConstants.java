...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(14, 0, 2.5, 14.7025);
    ...
    public static double GEAR_RATIO = .99782; // output (wheel) speed / input (motor) speed
